...
class dp_unet_CBAM(nn.Module):
    def __init__(self,in_ch=3,out_ch=1):
        super(dp_unet_CBAM, self).__init__()
        ...
        self.dp_conv5 = nn.Conv2d(1024,out_ch,1)
        self.up6 = nn.ConvTranspose2d(1024, 512, 2, stride=2)
        self.conv6 = DoubleConv_CBAM(1024, 512)
        self.dp_conv6 = nn.Conv2d(512,out_ch,1)

        self.up7 = nn.ConvTranspose2d(512, 256, 2, stride=2)
        self.conv7 = DoubleConv_CBAM(512, 256)
        self.dp_conv7 = nn.Conv2d(256,out_ch,1)

        self.up8 = nn.ConvTranspose2d(256, 128, 2, stride=2)
        self.conv8 = DoubleConv_CBAM(256, 128)
        self.dp_conv8 = nn.Conv2d(128,out_ch,1)
        
        self.up9 = nn.ConvTranspose2d(128, 64, 2, stride=2)
        self.conv9 = DoubleConv_CBAM(128, 64)
    ...
    def forward(self,x):
        ...
        p4=self.pool4(c4)
        c5=self.conv5(p4)
        dp0 = self.dp_conv5(c5)
        dp0 = _upsample_like(dp0,c1)
        up_6= self.up6(c5)
