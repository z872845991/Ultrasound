...
class Unet(nn.Module):
    def __init__(self,n_class):
        super().__init__()
        #3->64
        self.conv_down1=Self_Attention(3,3,64)
        self.conv_down2=Self_Attention(64,3,128)
        self.conv_down3=Self_Attention(128,3,256)
        self.conv_down4=Self_Attention(256,3,512)
        self.conv_down5=Self_Attention(512,3,1024)

        self.maxpool=nn.MaxPool2d(2)

        self.up1=nn.ConvTranspose2d(1024,512,2,stride=2)
        self.conv_up1=Self_Attention(1024,3,512)

        self.up2=nn.ConvTranspose2d(512,256,2,stride=2)
        self.conv_up2=Self_Attention(512,3,256)

        self.up3=nn.ConvTranspose2d(256,128,2,stride=2)
        self.conv_up3=Self_Attention(256,3,128)

        self.up4=nn.ConvTranspose2d(128,64,2,stride=2)
        self.conv_up4=Self_Attention(128,3,64)
