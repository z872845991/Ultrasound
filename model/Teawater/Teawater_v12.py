...
class Channelatt(nn.Module):
    def __init__(self, in_channel,decay=2):
        ...
        self.layer = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            ##nn.BatchNorm2d(in_channel//decay),  ## [Add this]
...
class Spaceatt(nn.Module):
    def __init__(self, in_channel,decay=2):
        ...
        self.Q = nn.Sequential(
            ...
            nn.ReLU(inplace=True),  ##v12 nn.BatchNorm2d -> nn.ReLU
...
class Teawater_v12(nn.Module):
    def __init__(self, n_class=1,decay=2):
        super(Teawater_v12, self).__init__()
