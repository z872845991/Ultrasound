...
bottleneck与解码器输出xiangjia，除了最后一层
'''
...
class Teawater_v50(nn.Module):
    def __init__(self, n_class=1,decay=2):
        super(Teawater_v50, self).__init__()
        ...
        self.decodeup3=nn.Conv2d(512,256,1)
        self.decodeup2=nn.Conv2d(256,128,1)
    ...
    def forward(self, inputs):
        ...
        decoderup3=F.interpolate(decoderup3,(h//4,w//4),mode='bilinear',align_corners=False)
        out3=self.dp3(deco3)
        ...
        decoderup2=F.interpolate(decoderup2,(h//2,w//2),mode='bilinear',align_corners=False)
        out2=self.dp2(deco2)
