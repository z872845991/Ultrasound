...
class Channelatt(nn.Module):
    def __init__(self, in_channel, decay=2):
        ...
        self.gmpool = nn.AdaptiveMaxPool2d(1)
...
class Teawater_v35(nn.Module):
    def __init__(self, n_class=1, decay=2):
        super(Teawater_v35, self).__init__()
    ...
    def forward(self, inputs):
        ...
        out2 = self.dp2(deco2)
        out2 = F.interpolate(
            out2, (h, w), mode='bilinear', align_corners=False)
