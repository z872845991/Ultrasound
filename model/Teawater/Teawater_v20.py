...
class En_blocks(nn.Module):
    def __init__(self, in_channel, out_channel,decay=1):
        ...
        self.channelatt=Channelatt(out_channel,16)
...
class Channelatt(nn.Module):
    def __init__(self, in_channel,decay=8):
...
class Teawater_v20(nn.Module):
    def __init__(self, n_class=1,decay=2):
        super(Teawater_v20, self).__init__()
